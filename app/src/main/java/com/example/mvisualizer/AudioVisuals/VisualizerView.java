package com.example.mvisualizer.AudioVisuals;
...
import com.example.mvisualizer.R;
...
public class VisualizerView extends View {
    ...
    public void setColor(String newColorKey) {
        ...
        if (newColorKey.equals(getContext().getString(R.string.value_label_blue_option))) {
        ...
        } else if (newColorKey.equals(getContext().getString(R.string.value_label_green_option))) {
